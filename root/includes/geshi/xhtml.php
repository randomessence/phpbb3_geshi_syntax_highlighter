 ...
 *
 * xhtml 1.1 language file for GeSHi.
 *
 * CHANGES
 * -------
 * 2009/06/24 (1.0.0)
...
* @ignore
*/
if (!defined('IN_PHPBB') || !defined('IN_XS_BBCODE'))
{
	exit;
}
...
$language_data = array (
    ...
    'KEYWORDS' => array(
        2 => array(
            ...
            'base', 'bdo', 'big', 'blockquote', 'body', 'br', 'button', 'b',

            'caption', 'cite', 'code', 'colgroup', 'col',
